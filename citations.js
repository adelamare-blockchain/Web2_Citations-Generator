// Etape 1 : récupération éléments HTML
let nouveau = document.querySelector('#nouveau');
let citation = document.querySelector('#citation');
let auteur = document.querySelector('#auteur');

// Etape 2 : Déclaration variables utiles
let dernier = 0; // contient l'index de la question actuellement affichée
let nombreAleatoire; // contient le nombre aléatoire généré
...
// Etape 4 : Générer un nombre aléatoire
